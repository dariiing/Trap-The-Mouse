...
def draw_title_and_timer(surface, timer):
    title_font = pygame.font.Font("MagicEnglish.ttf", 60)
...
def main():
    ...
    original_image = pygame.image.load("mickey_mouse.png")
    ...
    while run:
        ...
        draw_button(50, 400, 300, 60, "Player vs AI (Medium)", lambda: run_game("Trap the Mouse - PvAI Medium", 25, 15, 20))
